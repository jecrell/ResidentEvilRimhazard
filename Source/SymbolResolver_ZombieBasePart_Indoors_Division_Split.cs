// RimWorld.BaseGen.SymbolResolver_BasePart_Indoors_Division_Split
...
namespace RERimhazard
{
    ...
    public class SymbolResolver_ZombieBasePart_Indoors_Division_Split : SymbolResolver
    {
        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            else if ((Rand.Bool && rp.rect.Height >= 9) || rp.rect.Width < 9)
            {
                ...
                BaseGen.symbolStack.Push("zombieBasePart_indoors", resolveParams2);
            }
            else
            {
                ...
                BaseGen.symbolStack.Push("zombieBasePart_indoors", resolveParams3);
                ResolveParams resolveParams4 = rp;
                resolveParams4.rect = new CellRect(rp.rect.minX + num2, rp.rect.minZ, rp.rect.Width - num2, rp.rect.Height);
                BaseGen.symbolStack.Push("zombieBasePart_indoors", resolveParams4);
            }
        }
    }
}