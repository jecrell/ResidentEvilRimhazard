...
public class LordJob_DefendZombieBase : LordJob
{
    private Faction faction;

    private IntVec3 baseCenter;

    public LordJob_DefendZombieBase()
    {
    }

    public LordJob_DefendZombieBase(Faction faction, IntVec3 baseCenter)
    {
