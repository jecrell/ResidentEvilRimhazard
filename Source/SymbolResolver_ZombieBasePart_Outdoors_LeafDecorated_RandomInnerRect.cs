...
{
    public class SymbolResolver_ZombieBasePart_Outdoors_LeafDecorated_RandomInnerRect : SymbolResolver
    {
        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            BaseGen.symbolStack.Push("zombieBasePart_outdoors_leaf", resolveParams);
        }
    }
}