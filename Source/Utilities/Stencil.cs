...
{
    //Original code from RimCities. Used with permission.
    public struct Stencil
    {
        ...
        {
            return pos.InBounds(map) && (mask == null || mask(pos));
        }
        ...
        private Thing DoSpawn(IntVec3 pos, ThingDef thing, ThingDef stuff)
        {
        ...
        public delegate bool Mask(IntVec3 pos);
    }
}
